  ...
  return (
    <div className="space-y-8">
      <section className="bg-white rounded-lg shadow-card p-8">
        ...
        <p className="text-lg text-gray-700 leading-relaxed mb-4">
          A working group of 50+ Chief Information Security Officers — the people who run security at Google, the former U.S. national cyber director, Bruce Schneier, the former CISO of CISA — wrote a 29-page playbook in April 2026 (now at v1.0, May 1, 2026) explaining what every organization should do about it. It's called <a href="https://labs.cloudsecurityalliance.org/mythos-ciso/" target="_blank" rel="noopener noreferrer" className="text-mtm-primary underline font-semibold">"The AI Vulnerability Storm: Building a Mythos-ready Security Program"</a> and it's published openly by the Cloud Security Alliance. <strong>They wrote it for organizations that have a security team and a security budget.</strong>
        </p>
