  ...
  return (
    <div className="space-y-8">
      <section className="bg-white rounded-lg shadow-card p-8">
        ...
        <p className="text-lg text-gray-700 leading-relaxed mb-4">
          A working group of 50+ Chief Information Security Officers — the people who run security at Google, the former U.S. national cyber director, Bruce Schneier, the former CISO of CISA — wrote a 29-page playbook in April 2026 (current v1.0, dated April 18, 2026) explaining what every organization should do about it. It's called <a href="https://labs.cloudsecurityalliance.org/mythos-ciso/" target="_blank" rel="noopener noreferrer" className="text-mtm-primary underline font-semibold">"The AI Vulnerability Storm: Building a Mythos-ready Security Program"</a> and it's published openly by the Cloud Security Alliance. <strong>They wrote it for organizations that have a security team and a security budget.</strong>
        </p>
      ...
      <section className="bg-white rounded-lg shadow-card p-8">
        ...
        <p className="text-base text-gray-700 leading-relaxed mb-3">
          The <a href="https://cloudsecurityalliance.org/" target="_blank" rel="noopener noreferrer" className="text-mtm-primary underline">CSA</a> / <a href="https://www.sans.org/" target="_blank" rel="noopener noreferrer" className="text-mtm-primary underline">SANS</a> / <a href="https://unpromptedcon.org/" target="_blank" rel="noopener noreferrer" className="text-mtm-primary underline">[un]prompted</a> / <a href="https://genai.owasp.org/" target="_blank" rel="noopener noreferrer" className="text-mtm-primary underline">OWASP</a> working group — including Jen Easterly (former Director of <a href="https://www.cisa.gov/" target="_blank" rel="noopener noreferrer" className="text-mtm-primary underline">CISA</a>), Bruce Schneier, Heather Adkins, Phil Venables, Bob Lord, and Rob Joyce — first published <em>"The AI Vulnerability Storm: Building a Mythos-ready Security Program"</em> on April 12, 2026; the current v1.0 is dated April 18, 2026.
        </p>
        <p className="text-base text-gray-700 leading-relaxed mb-3">
        ...
        <p className="text-base text-gray-700 leading-relaxed mb-3">
          The v1.0 update of the working group paper added an important caveat: <strong>the time-to-exploit collapse hasn't yet produced a proportional increase in actual breach impact.</strong> Most consequential incidents of recent years still come from credential abuse, social engineering, and supply chain compromise — not zero-day exploitation. The Zero Day Clock is a leading indicator of where attacker capability is heading, not a measure of current damage. That distinction matters for how a small or mid-size nonprofit prioritizes: <strong>your phishing-resistant MFA and your tested backups are still the highest-leverage controls you have.</strong>
        </p>
      ...
      <section className="bg-white rounded-lg shadow-card p-8 border-l-4 border-mtm-accent">
        <div className="mb-4">
          <p className="text-sm uppercase tracking-widest text-mtm-accent font-semibold">What's changed since v1.0 was published</p>
          <h3 className="text-2xl font-bold text-mtm-navy mt-1">Three updates from May 2026 — not in the paper.</h3>
        </div>
        <ul className="space-y-3 text-base text-gray-700 leading-relaxed list-disc pl-6">
          <li>
            <strong>First AI-weaponized zero-day confirmed in the wild (early May 2026).</strong> Google Threat Intelligence Group identified a Python script — assessed with high confidence to have been authored by an LLM — that bypasses two-factor authentication on a popular open-source web-based system-administration tool. The paper's threat model is no longer speculative. <em>What it means for you:</em> the case for phishing-resistant MFA (hardware keys, not SMS) just got firmer for any admin account.
          </li>
          <li>
            <strong>The vibe-coding shadow inventory is 380,000 apps deep (May 7, 2026).</strong> Israeli security firm RedAccess published a scan of public projects built on Lovable, Base44, Replit, and Netlify: ~380,000 apps reachable on the open web, ~5,000 containing sensitive corporate data, and Lovable-built phishing sites impersonating Bank of America, FedEx, Trader Joe's, and McDonald's. Defaults on most of these platforms are "public unless you toggle it." <em>What it means for you:</em> if any staff member has built anything with these tools, treat it as a high-priority inventory item this quarter — check the visibility setting first.
          </li>
          <li>
            <strong>Claude Security entered public beta for Enterprise (May 1, 2026)</strong> with new capabilities aimed at scale: scheduled scans, directory-scoped scans, dismiss-with-reason workflows, CSV/Markdown export, and Slack/Jira/webhook integration. Claude Team and Max access is "coming soon." <em>What it means for you:</em> Action #1 ("Point Agents at Your Code") is now closer to a turnkey choice; if your MSP or in-house IT runs anything on Claude Enterprise, the new beta is worth enabling on the codebases and vibe-coded apps you've inventoried.
          </li>
        </ul>
        <p className="text-xs text-gray-500 mt-4">Sources: <a href="https://thehackernews.com/2026/05/hackers-used-ai-to-develop-first-known.html" target="_blank" rel="noopener noreferrer" className="text-mtm-primary underline">The Hacker News</a> (AI-weaponized 2FA bypass) · <a href="https://www.axios.com/2026/05/07/loveable-replit-vibe-coding-privacy" target="_blank" rel="noopener noreferrer" className="text-mtm-primary underline">Axios</a> and <a href="https://venturebeat.com/security/vibe-coded-apps-shadow-ai-s3-bucket-crisis-ciso-audit-framework" target="_blank" rel="noopener noreferrer" className="text-mtm-primary underline">VentureBeat</a> (RedAccess study) · <a href="https://www.helpnetsecurity.com/2026/05/04/anthropic-claude-security-public-beta/" target="_blank" rel="noopener noreferrer" className="text-mtm-primary underline">Help Net Security</a> (Claude Security beta).</p>
      </section>
